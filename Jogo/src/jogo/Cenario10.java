...
public class Cenario10 extends Cenario{
	...
	public Cenario10 (Window window, Jogador player) {
		
		janela = window;
		cena = new Scene();
		cena.loadFromFile(URL.scenario("Cenario10_15.scn"));
		jogador = player;
		teclado = janela.getKeyboard();
		troll = new Troll[4];
		ouro = new Ouro(350,250);
	}
	public void run() {
