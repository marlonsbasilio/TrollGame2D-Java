...
public class Cenario13 extends Cenario{
	...
	public Cenario13 (Window window, Jogador player) {
		
		janela = window;
		cena = new Scene();
		cena.loadFromFile(URL.scenario("Cenario13_19.scn"));
		jogador = player;
		teclado = janela.getKeyboard();
		troll = new Troll[2];
		ouro = new Ouro(300,200);
	}
	public void run() {
